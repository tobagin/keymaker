...
### 🏗️ Maintenance
- **Runtime**: Updated to GNOME 50 platform/SDK.
- **Dependencies**: Updated bundled OpenSSH to 10.3p1.
- **Dependencies**: Updated bundled VTE terminal widget to 0.84.0.
- **Dependencies**: Updated libsoup (3.6.6), simdutf (9.0.0), and fast_float (8.2.6).
